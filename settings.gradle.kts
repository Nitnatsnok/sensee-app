...
include(":shared:ai:curated-enrichment")
include(":shared:ai:llm")
include(":shared:ai:integration")
include(":shared:verification:core")
include(":shared:verification:sensee-curated")
include(":shared:verification:free-dictionary")
include(":shared:verification:datamuse")
include(":shared:verification:database-schema")
include(":shared:verification:languagetool")
include(":shared:verification:integration")
include(":shared:grammar:domain")
include(":shared:grammar:data")
include(":shared:lexicon:domain")
include(":shared:lexicon:enrichment")
include(":shared:lexicon:serialization")
include(":shared:lexicon:database-schema")
include(":shared:lexicon:data")
...
include(":shared:feature:startup:domain")
