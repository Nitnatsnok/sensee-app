...
public val Autoplay24px: ImageVector
    get() {
        val current = _autoplay24px
        if (current != null) return current

        return ImageVector
            .Builder(
                name = "app.sensee.ui.designSystem.theme.SenseeTheme.Autoplay24px",
            ...
            .also { _autoplay24px = it }
    }

@Suppress("ObjectPropertyName")
private var _autoplay24px: ImageVector? = null
