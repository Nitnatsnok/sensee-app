...
import app.sensee.ai.core.wire.AlignmentChunkV1
 ...
 * Intentional boundary mirror: the wire [AlignmentChunkV1], this neutral form,
 * the lexical-domain `AlignmentChunk` and the persist `AlignmentChunkDto` are
 * four thin reps with an identical field shape across the seams by design
 * (ADR-005), each kept dependency-light — not a missing dedup.
 */
