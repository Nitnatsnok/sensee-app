...
@Inject
public class VocabularyEditorConfigSerializersProvider : ScreenConfigSerializersProvider {
    @OptIn(ExperimentalSerializationApi::class)
    override val serializersModule: SerializersModule =
        screenConfigSerializersModule { subclassesOfSealed<VocabularyEditorConfig>() }
}
